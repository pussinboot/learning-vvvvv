...
namespace VVVV.Nodes
{
	...
	public class CustomDeviceData : DeviceData
	{
		...
		public CustomDeviceData(Texture tex, VertexBuffer vb) : base()
		{
			Tex = tex;
			VB = vb;
		}
	...
	#region PluginInfo
	[PluginInfo(Name = "Templatee", Category = "EX9", Help = "Basic template which renders directly into the vvvv Renderer(EX9)", Tags = "")]
	#endregion PluginInfo
	public class EX9TemplateeNode : DXLayerOutPluginBase<CustomDeviceData>, IPluginEvaluate
	{
		#region fields & pins
		...
		public EX9TemplateeNode(IPluginHost host) : base(host, true, true)
		{
		}
